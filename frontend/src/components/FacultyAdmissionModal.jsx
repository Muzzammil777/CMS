          ...
          <div className="min-h-[300px]">{currentStep === 1 && (
            ...
            {currentStep === 3 && (
              <div className="space-y-4"><h2 className="text-xl font-bold text-gray-800 mb-4">Qualifications</h2><div><label className="block text-sm font-medium text-gray-700 mb-2">Highest Qualification *</label><select
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600"
                  ><option value="">Select</option><option value="B.Sc (Medical Laboratory Technology)">B.Sc (Medical Laboratory Technology)</option><option value="B.Sc (Operation Theatre and Anaesthesia Technology)">B.Sc (Operation Theatre and Anaesthesia Technology)</option><option value="B.Sc (Radiography and Imaging Technology)">B.Sc (Radiography and Imaging Technology)</option><option value="B.Sc">B.Sc (Bachelor of Science)</option><option value="M.Sc">M.Sc (Master of Science)</option><option value="MD">MD (Doctor of Medicine)</option><option value="MS">MS (Master of Surgery)</option><option value="Ph.D.">Ph.D. (Doctor of Philosophy)</option><option value="Post-Doc">Post-Doctoral Fellowship</option></select></div><div className="grid grid-cols-2 gap-4"><div><label className="block text-sm font-medium text-gray-700 mb-2">Specialization</label><input
                      type="text"
                      name="specialization"
