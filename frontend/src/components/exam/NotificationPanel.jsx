...
export default function NotificationPanel({ studentId, isOpen, onClose }) {
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      ...
      default: return { icon: 'info', color: 'text-[#4c1d95]' };
    }
  };
        ...
        <div className="bg-[#4c1d95] text-white px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              {unreadCount > 0 && (
                <span className="bg-white text-[#4c1d95] text-xs font-bold px-2 py-1 rounded-full">
                  {unreadCount}
                </span>
              )}
            </div>
        ...
        {unreadCount > 0 && (
          <div className="px-4 py-3 bg-slate-50 border-b">
            <button
              ...
              className="text-sm text-[#4c1d95] hover:text-[#4c1d95]/80 font-medium flex items-center gap-1"
            >
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        {!notif.read && (
                          <button
                            ...
                            className="text-xs text-[#4c1d95] hover:text-[#4c1d95]/80 font-medium"
                          >
                            Mark as read
                          </button>
                        )}
