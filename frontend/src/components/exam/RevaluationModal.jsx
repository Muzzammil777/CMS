        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#4c1d95]/20 focus:border-[#4c1d95] outline-none resize-none"
            />
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex-1 px-4 py-2 bg-[#4c1d95] text-white rounded-lg hover:bg-[#4c1d95]/90 transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            >
