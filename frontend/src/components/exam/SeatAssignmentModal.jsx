    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-slate-900/50 backdrop-blur-sm">
      <div className="bg-white rounded-t-2xl sm:rounded-xl shadow-2xl w-full max-w-2xl max-h-[95vh] sm:max-h-[85vh] overflow-hidden flex flex-col transition-all duration-300">
        ...
        <div className="p-4 sm:p-6 border-b border-slate-200 flex items-center justify-between bg-slate-50/50 flex-shrink-0">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[#00236f]/10 rounded-lg">
              <span className="material-symbols-outlined text-[#00236f]">event_seat</span>
            </div>
            <div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5">
          ...
          <div className="bg-slate-50 border border-slate-200 p-4 rounded-xl">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 sm:items-end">
              <div className="flex-1">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#00236f]/20 focus:border-[#00236f] outline-none text-sm bg-white text-slate-800"
                >
              ...
              <button
                ...
                className="px-4 py-2.5 bg-[#00236f] text-white rounded-lg hover:bg-[#00236f]/90 disabled:bg-slate-300 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-semibold text-sm shadow-sm transition-all"
              >
            ...
            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mt-3">
              Total Students: <span className="text-slate-800 font-bold">{registrations.length}</span> | Assigned: <span className="text-[#00236f] font-bold">{Object.keys(assignments).filter(k => assignments[k]).length}</span>
            </p>
          </div>
                ...
                <div key={reg.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 bg-white border border-slate-100 hover:border-slate-200 rounded-xl transition-all shadow-sm">
                  ...
                  <div className="w-full sm:w-44 flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2.5 sm:py-2 border border-slate-200 rounded-lg text-center text-sm font-semibold focus:ring-2 focus:ring-[#00236f]/20 focus:border-[#00236f] outline-none"
                    />
                  </div>
                </div>
              ))}
        ...
        <div className="p-4 sm:p-6 border-t border-slate-200 flex flex-col-reverse sm:flex-row justify-end gap-3 bg-slate-50/50 flex-shrink-0">
          ...
          <button
            onClick={handleSave}
            className="w-full sm:w-auto px-5 py-2.5 bg-[#00236f] text-white rounded-lg hover:bg-[#001a54] transition-colors font-semibold text-sm shadow-sm flex items-center justify-center"
          >
            Save Assignments
          </button>
        </div>
