...
export default function DepartmentSettings() {
  ...
  const inputClasses = "w-full px-4 py-2 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#4c1d95]/10 focus:border-[#4c1d95] outline-none transition-all text-sm text-slate-700";
    ...
    <section className="settings-card-grid">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-1.5">
            <label className={labelClasses}>HOD</label>
            <input
              type="text"
