    ...
    <div className="space-y-1">
      ...
      <div className="relative">
        <input
          ...
          } focus:outline-none focus:ring-2 focus:ring-[#00236f]/25 transition-colors`}
        />
        <button
          type="button"
          onClick={() => setShow(s => !s)}
    ...
    <div className="flex flex-col gap-5">
        ...
        <form onSubmit={handleChangePassword} className="space-y-4" noValidate>
          ...
          <div className="flex gap-2 pt-1">
            <button
              type="submit"
              disabled={pwSaving}
              className="inline-flex items-center gap-2 px-5 py-2 bg-[#00236f] hover:bg-[#1e4d18] text-white text-sm font-semibold rounded-lg transition-all shadow-sm active:scale-95 disabled:opacity-60"
            >
              {pwSaving ? (
                <>
      ...
      <SettingsCard title="Active Sessions" description="Devices currently logged in to your account.">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={load} className="text-xs font-semibold text-[#00236f] hover:underline flex items-center gap-1">
