      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 px-4 py-3 border-t border-slate-100 bg-white rounded-b-xl">
        ...
        <div className="flex items-center gap-3 text-xs text-slate-500">
          ...
          <select
            ...
            className="ml-2 border border-slate-200 rounded-lg px-2 py-1 text-xs font-medium text-slate-700 bg-white focus:outline-none focus:ring-2 focus:ring-[#6d28d9]/20"
          >
            {[5, 10, 20, 50].map(n => (
