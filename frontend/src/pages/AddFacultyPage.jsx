...
export default function AddFacultyPage() {
  ...
  return (
    <Layout title="Add New Faculty"><div className="space-y-4">{/* Page Header */}
        <div className="bg-white rounded-lg shadow p-4 flex items-center justify-between"><div className="flex items-center gap-3"><div className="p-2 bg-[#00236f]/10 rounded-lg"><span className="material-symbols-outlined text-lg text-[#00236f]">school</span></div><div><h1 className="text-lg font-bold text-gray-900">Add New Faculty</h1><p className="text-xs text-gray-600 mt-0.5">Step {currentStep} of 5: {steps[currentStep-1].title}</p></div></div><button
                  ...
                  {!formData.useAutoPassword && (
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        <input type={showPassword ? 'text' : 'password'} name="defaultPassword" value={formData.defaultPassword} onChange={handleInputChange} className="w-full px-3 py-2 pr-10 text-sm rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#00236f]/20" placeholder="Enter default password" />
