    ...
    <div className="relative group h-full overflow-visible">
      ...
      {canEdit && (
        <div className="absolute inset-0 flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 bg-white/80 rounded-r-lg transition-opacity z-10">
          <button
            onClick={onEdit}
            className="p-1 rounded-md bg-[#00236f] text-white hover:bg-[#00236f]/90"
            title="Edit"
          >
...
function EntryModal({ initial, onSave, onClose }) {
  ...
  const inputCls = 'w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#00236f]/20 focus:border-[#00236f] transition-all'
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <div className="flex items-center gap-2">
            <span className="material-symbols-outlined text-[#00236f]">schedule</span>
        ...
        <div className="flex justify-end gap-3 px-6 py-4 border-t border-slate-100 bg-slate-50">
          ...
          <button
            onClick={handleSave}
            className="px-5 py-2 bg-[#00236f] text-white rounded-lg text-sm font-semibold hover:bg-[#00236f]/90 active:scale-95 shadow-sm"
          >
            Save
          </button>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <div className="flex items-center gap-2">
            <span className="material-symbols-outlined text-[#00236f]">add_circle</span>
      ...
      <div className="flex items-center gap-2 mb-6 flex-wrap">
        ...
        {canEdit && (
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-semibold border border-dashed border-slate-300 text-slate-500 hover:border-[#00236f] hover:text-[#00236f] transition-all"
          >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold border transition-all ${
                showPeriodEditor
                  ...
                  : 'bg-white text-slate-600 border-slate-200 hover:border-[#00236f] hover:text-[#00236f]'
              }`}
            >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-end">
              <button
                type="button"
                onClick={addPeriod}
                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg border border-slate-200 bg-white text-sm font-semibold text-slate-700 hover:border-[#00236f] hover:text-[#00236f]"
              >
                ...
                <div key={idx} className="text-xs font-semibold text-slate-600">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3 pr-10 py-2 border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#00236f]/20 focus:border-[#00236f]"
                    />
                    <button
                      type="button"
                ...
                {breakItems.map((item) => (
                  <div key={item.id} className="grid grid-cols-[1fr_auto_auto] gap-2 items-center">
                    <input
                      ...
                      className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#00236f]/20 focus:border-[#00236f]"
                    />
                    <select
                      value={item.tone}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                {editableBreakBoundaries.map((boundary) => {
                  ...
                  const badgeClass = itemsAtBoundary.length > 0
                    ...
                    : draggingBreakId
                      ? 'bg-[#00236f]/5 border-[#00236f]/30 text-[#00236f]'
